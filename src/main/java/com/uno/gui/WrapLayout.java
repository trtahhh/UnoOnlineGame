...
/**
 * FlowLayout cải tiến hỗ trợ xuống dòng và cuộn tốt hơn
...
public class WrapLayout extends FlowLayout {
    ...
    /**
     * Constructs a new <code>FlowLayout</code> with the specified alignment and a default
     * 5-unit horizontal and vertical gap. The value of the alignment argument must be one
     ...
     * @return the preferred dimensions to lay out the subcomponents of the specified
     *         container
     */
    @Override
